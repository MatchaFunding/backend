 ...
 */
export function convertDatabaseToTypescript(database, config) {
 ...
 */
export function handleNumeric(value) {
 ...
 */
export async function generateDatabase(config, db) {
...
//# sourceMappingURL=DatabaseTasks.js.map