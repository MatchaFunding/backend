 ...
 */
export async function getColumnsForTable(db, table, config) {
    ...
    return columns.map(column => ({
        ...
        propertyType: convertType(column, table, config, db.client.dialect),
 ...
 */
export function getOptionality(column, table, config) {
 ...
 */
export function generateFullColumnName(tableName, schemaName, columnName) {
 ...
 * @returns {string}
 */
export function convertType(column, table, config, dialect) {
 ...
 * @returns {string}
 */
export function convertStandardType(column, table, config, dialect) {
 ...
 * @returns {string}
 */
export function convertNumericEnumType(column, config) {
 ...
 * @returns {string}
 */
export function convertStringEnumType(column) {
    return column.stringEnumValues.map(v => `'${v}'`).join(' | ');
}
//# sourceMappingURL=ColumnTasks.js.map