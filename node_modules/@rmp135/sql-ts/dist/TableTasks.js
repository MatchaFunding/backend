 ...
 */
export async function getAllTables(db, config) {
 ...
 * @param {Config} config The configuration to use.
 */
export function getAdditionalProperties(tableName, schemaName, config) {
 ...
 * @returns {string}
 */
export function getExtends(tableName, schemaName, config) {
    const fullName = `${schemaName}.${tableName}`;
 ...
 * @returns
 */
export function generateInterfaceName(name, config) {
...
//# sourceMappingURL=TableTasks.js.map