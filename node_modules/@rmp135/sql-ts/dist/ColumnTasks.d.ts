 ...
 */
export declare function generateFullColumnName(tableName: string, schemaName: string | null, columnName: string): string;
/**
 ...
 * @returns {string}
 */
export declare function convertStandardType(column: ColumnDefinition, table: TableDefinition, config: Config, dialect: string): string;
/**
 ...
 * @returns {string}
 */
export declare function convertNumericEnumType(column: ColumnDefinition, config: Config): string;
/**
 ...
 * @returns {string}
 */
export declare function convertStringEnumType(column: ColumnDefinition): string;
